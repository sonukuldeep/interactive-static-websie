...
rgbKineticSlider = new rgbKineticSlider({
  ...
  cursorMomentum: 0.2, // lower is slower
  ...
  googleFonts: ["Lato:400", "Lato:700"], // select google font to use
  ...
  textSubTitleSize: 60, // subtitle size
  mobileTextSubTitleSize: 60, // mobile subtitle size
